#
#  Be sure to run `pod spec lint DXTools.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jerry-DX"
  # s.authors            = { "Jerry-DX" => "xfr815113499@126.com" }
  # s.social_media_url   = "http://twitter.com/Jerry-DX"
